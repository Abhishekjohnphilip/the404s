...
import { addYear, addEvent, deleteEvent, deleteYear, updateEvent, addAdmin, deleteAdmin, logout } from '@/app/actions';
...
export default function AdminDashboard({ currentUser }: { currentUser: string }) {
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <form action={handleLogout}>
                        <Button variant="outline" type="submit"><LogOut className="mr-2" />Logout</Button>
                    </form>
                </div>
            </div>
